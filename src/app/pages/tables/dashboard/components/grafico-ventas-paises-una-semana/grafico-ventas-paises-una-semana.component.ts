...
@Component({
  selector: 'ngx-grafico-ventas-paises-una-semana',
  templateUrl: './grafico-ventas-paises-una-semana.component.html',
  styleUrls: ['./grafico-ventas-paises-una-semana.component.scss']
})
export class GraficoVentasPaisesUnaSemanaComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.authSvc.graficoVentasPaisesUnaSemana().subscribe(data=>{
      this.grafico = data
      ...
      let option
      var dom = document.getElementById("containerPaisesUnaSemana");
