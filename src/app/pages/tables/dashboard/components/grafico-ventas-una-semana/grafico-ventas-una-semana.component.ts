...
@Component({
  selector: 'ngx-grafico-ventas-una-semana',
  templateUrl: './grafico-ventas-una-semana.component.html',
  styleUrls: ['./grafico-ventas-una-semana.component.scss']
})
export class GraficoVentasUnaSemanaComponent implements OnInit {

  constructor(public authSvc: AuthService) { }

  ngOnInit(): void {
    this.authSvc.graficoVentasUnaSemana().subscribe(data=>{
        ...
        series: [
          {
            ...
            data: [
              ...
              { value: data[0].Sum_Vipalia, name: 'Vipalia' }
            ],
            color: ['#008AF8','#131921','#002D72','#00E8CB','#E63107','#E41A15','#4674B4','#BDBEC0','#383637','#008B55','#52B9E2','#E8A6BC','#E1A925','#DF0000','#FF9400','#17B3EA','#D8A27A'],
            emphasis: {
              itemStyle: {
                shadowBlur: 10,
                shadowOffsetX: 0,
